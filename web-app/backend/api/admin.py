...
admin.site.register(api_models.NewsArticle)
admin.site.register(api_models.NewsArticleComment)
admin.site.register(api_models.NewsArticleBookmark)
admin.site.register(api_models.WordSentimentTrend)